...
| `mobile_implementation_map/02-profile.md` | TeachingProfile · wheels · shared budget | 98 | 74 | 1 | 0 | 2 | 10 | 11 (7 DIVERGED — founder Q8) |
| `mobile_implementation_map/03-firstrun-login.md` | Login · PrivacyNotice · Agreement · FirstRun | 120 | 113 | 1 | 0 | 1 | 4 | 1 |
| `mobile_implementation_map/04-settings-askmeyy.md` | Settings (7 subviews) · Ask Meyy · Dropdown | 122 | 116 | 0 | 0 | 1 | 0 | 5 |
| `mobile_implementation_map/05-lists-prepare.md` | My Classes · My Lessons · Prepare · Year Plan | 127 | 107 | 2 | 0 | 1 | 11 | 6 |
