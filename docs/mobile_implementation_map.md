...
**Owed before anything new:** a walk of the **two pick screens** on a profile with MORE THAN ONE
subject·class. They cannot be exercised on the founder's own account (English · Class 3 only), which
skips both by design, and signing in as anyone else is his act, not ours — so what is verified today is
that the SKIPS still skip and the routing rule passes 9 node tests. The screens' own rendering, the ←
between them, and the stage-scope narrowing of the class list are owed a walk. Ask him for a test
account that teaches two subjects, or two classes in one.
