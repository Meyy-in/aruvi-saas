...
| B11 | Card "Legal" / "User agreement & privacy notice" › → `setView("legal")` — shown on trial too | 1039–1043 | MISSING | — | §G | |
| B12 | Card "About Meyy" / "Version info" › → `setView("about")` | 1044–1048 | MISSING | — | §H | |
